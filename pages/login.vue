        ...
        <div class="px-6 py-8 w-full max-w-md">
         ...
         bg-gradient-to-br from-cyan-400 via-blue-500 to-pink-500 opacity-80 hover:opacity-100"
          ...
          <div class="lg:hidden mt-8">
            ...
            >
              <span>{{ showMobileInfo ? $t('pages.login.hide_info') : $t('pages.login.more_info')}}</span>
              <svg 
          ...
          >
            <h3 class="text-white font-semibold mb-2">{{ $t('pages.login.info_title') }}</h3>
            <p class="text-gray-300 text-sm mb-4">
              {{ $t('pages.login.info_text_1') }}
            </p>
            <p class="text-gray-300 text-sm mb-4">
              {{ $t('pages.login.info_text_2') }}
            </p>
            <div class="pt-4 border-t border-gray-700">
              <div class="flex items-center gap-2 text-xs text-gray-400">
                <span class="w-2 h-2 bg-yellow-500 rounded-full"></span>
                {{ $t('pages.login.beta_note') }}
              </div>
            </div>
          </div>
        </div>
